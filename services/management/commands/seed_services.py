...
SERVICES_DATA = [
    {'name': 'Lead Generation', 'icon': '🎯', 'order': 1,
    ...
    {'name': 'LinkedIn Outreach', 'icon': '🔗', 'order': 2,
    ...
    {'name': 'Cold Calling', 'icon': '📞', 'order': 3,
    ...
    {'name': 'Appointment Setting', 'icon': '📅', 'order': 4,
    ...
    {'name': 'Data Entry', 'icon': '🗂️', 'order': 5,
    ...
    {'name': 'Data Scraping', 'icon': '🕸️', 'order': 6,
    ...
    {'name': 'Email Marketing', 'icon': '📧', 'order': 7,
    ...
    {'name': 'Social Media Marketing', 'icon': '📱', 'order': 8,
    ...
    {'name': 'WordPress and Web Development', 'icon': '💻', 'order': 10,
